...
namespace Albatross.DateLevel.Test {
	public class TestTestGetOverlappedDateLevelEntities {
		...
		public void Test_1() {
			var list = BaseLine();
			var items = list.GetOverlappedDateLevelEntities(9999, new DateOnly(2024, 4, 1), new DateOnly(2024, 4, 1));
		...
		public void Test_5() {
			var list = BaseLine();
			var items = list.GetOverlappedDateLevelEntities(9999, new DateOnly(2024, 9, 1), new DateOnly(2024, 9, 1));
			Assert.Collection(items,
				x => {
